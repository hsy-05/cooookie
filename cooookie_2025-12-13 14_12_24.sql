...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(25, '2025_08_12_200124_create_news_category_desc_table', 12),
	(28, '2025_12_10_102250_create_product_table', 13),
	(29, '2025_12_10_102308_create_product_desc_table', 13);
...
-- 正在傾印表格  cooookie.news 的資料：~2 rows (近似值)
INSERT INTO `news` (`news_id`, `cat_id`, `image`, `is_visible`, `display_order`, `created_at`, `updated_at`) VALUES
	(8, 3, 'news/17655610864537.jpg', 1, 0, '2025-12-12 09:38:06', '2025-12-12 09:38:06'),
	(9, 1, NULL, 1, 0, '2025-12-12 10:43:10', '2025-12-12 10:43:10');
...
-- 正在傾印表格  cooookie.news_category 的資料：~4 rows (近似值)
INSERT INTO `news_category` (`cat_id`, `parent_id`, `parent_ids`, `super_id`, `is_visible`, `display_order`, `created_at`, `updated_at`) VALUES
	...
	(2, NULL, NULL, NULL, 1, 0, '2025-08-14 10:24:56', '2025-12-10 11:42:39'),
...
INSERT INTO `news_category_desc` (`cat_id`, `lang_id`, `name`, `description`, `content`, `created_at`, `updated_at`) VALUES
	(1, 1, '活動公告', NULL, '<p><br></p>', '2025-12-11 11:17:13', '2025-12-11 11:17:13'),
	(2, 1, '優惠活動', NULL, '<p><br></p>', '2025-12-11 11:16:17', '2025-12-11 11:16:17'),
	(3, 1, '最新公告', NULL, '<p><br></p>', '2025-12-11 11:16:10', '2025-12-11 11:16:10'),
	(4, 1, '測試', NULL, '<p><br></p>', '2025-12-11 11:17:20', '2025-12-11 11:17:20');
...
-- 正在傾印表格  cooookie.news_desc 的資料：~2 rows (近似值)
INSERT INTO `news_desc` (`news_id`, `lang_id`, `title`, `content`, `created_at`, `updated_at`) VALUES
	(8, 1, '消息標題1', '<p><br></p>', '2025-12-12 09:38:06', '2025-12-12 09:38:06'),
	(9, 1, 'D', '<p>DD</p>', '2025-12-12 10:43:10', '2025-12-12 10:43:10');
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `is_visible` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否顯示',
  `display_order` int(11) NOT NULL DEFAULT 0 COMMENT '排序',
  `image` varchar(255) DEFAULT NULL COMMENT '封面圖檔名',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
-- 正在傾印表格  cooookie.sessions 的資料：~10 rows (近似值)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('7rkFunvortgNOmvBsibyTJwXmEUGTLpSRIFFAhdN', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765606271),
	('axHS6n0Iom8ewPutlEVn4HRKOaCSIlFGf6YTB5H4', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoicHdIUWZCQjIyTlUzTzBIVDdDVG1hb2lsMkRWMUl5cEpVVUNwYVRUNiI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MzM6Imh0dHA6Ly9sb2NhbGhvc3Q6ODIvY29vb29raWUvbmV3cyI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1765606271),
	('C1I9Z3RAgtWL3ZgsFh0J3IZmkfWDTh2pVQN1mU4C', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765606272),
	('iREtbB7Ep1MAvCDjfg9UzqG8sQD4f3gw5ODPvuT8', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '', 1765566902),
	('lC6Wzuzs1GtDBXyRcHm3SImFymFNY6dpvfzsULEu', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765606271),
	('lGf0rGI3EdMRCtrKC0LysVnpLMbhzblYHYSwhdzS', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiRjhwRVh6N2JPUkZ0TVNic0s2anlUU0FFVmZabExkU1BCZ2NrU3laYSI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MzM6Imh0dHA6Ly9sb2NhbGhvc3Q6ODIvY29vb29raWUvbmV3cyI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1765606272),
	('lm3jXqdJDtFA3nN68GNg3whBz1VKOxRSrD8lEM2I', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765606271),
	('M2TKGtT3ziQMbUtj7PxDh2OjoLBJ3ftAffSf9cxv', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765606271),
	('oq4NYrjecNAKBOdRzbHyKNbNU7To8MWo2XJb7g14', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiQW84bG9qRnp3a05kNFdXTEU3WlgwM2VPU2JiQ2tnT3BwMVVneWdYMiI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6Mjg6Imh0dHA6Ly9sb2NhbGhvc3Q6ODIvY29vb29raWUiO31zOjY6Il9mbGFzaCI7YToyOntzOjM6Im9sZCI7YTowOnt9czozOiJuZXciO2E6MDp7fX19', 1765606271),
	('UE5i9XAyOdark8XjkwKsxi835oZPq9offEToux5Y', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765606272);

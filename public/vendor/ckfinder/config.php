...
$PUBLIC_PATH = dirname(dirname($CKFINDER_PATH));

// 3. 根目錄實體路徑（往上找到整個專案根）
$ROOT_PATH = dirname($PUBLIC_PATH);

// 4. 上傳目錄相對路徑
$UPLOAD_RELATIVE_PATH = 'storage/editor';
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => $BASE_URL,
    //  'root'         => '$UPLOAD_ABSOLUTE_PATH', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,

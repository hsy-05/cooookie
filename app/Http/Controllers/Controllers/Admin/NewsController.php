...
// use Intervention\Image\ImageManager; // 不再直接使用 ImageManager
// use Intervention\Image\Drivers\Gd\Driver; // 不再直接使用 Driver
use App\Helpers\ContentHelper;
use App\Helpers\ImageHelper; // 引入 ImageHelper
use App\Http\Controllers\Admin\BaseAdminController;
use Illuminate\Support\Facades\Storage; // 仍然需要 Storage 進行刪除操作

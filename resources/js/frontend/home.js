...
const initSwiper = (selector, navConfig, desktopCount = 3) => {
    ...
    const swiper = new Swiper(selector, {
        ...
        pagination: {
            ...
            // 要求「目前張數」顯示為 01、02、03... 格式
            formatFractionCurrent: (num) => num.toString().padStart(2, '0'),

            // 重點：在 loop 模式下，分頁顯示的 total 顯示成「原始資料總筆數」
            // 即使 Swiper 內部複製了很多圈，外面看到的還是 01 / 05、01 / 06，不會變成 01 / 05 → 01 / 07
            formatFractionTotal: () => {
    ...
    try {
        ...
        pagination: '.js-product-cat-pagination'
    }, 3);

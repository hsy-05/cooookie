...
@section('content')
    ...
    <x-admin.page-message>
        ...
        <form
            action="{{ isset($isEdit) ? route('admin.news_category.update', $news_category->cat_id) : route('admin.news_category.store') }}"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select id="is_visible" name="is_visible" class="form-control">
                                            <option value="1"
                                                {{ isset($isEdit) && $news_category->is_visible ? 'selected' : '' }}>顯示
                                            </option>
                                            <option value="0"
                                                {{ isset($isEdit) && !$news_category->is_visible ? 'selected' : '' }}>隱藏
                                            </option>
                                        </select>
                                    </div>

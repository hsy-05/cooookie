                                    ...
                                    <select id="cat_id" name="cat_id" class="form-control">
                                        ...
                                        @foreach ($cats as $cat)
                                            <option value="{{ $cat->cat_id }}"
                                                {{ $cat->cat_id == $news->cat_id ? 'selected' : '' }}>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('storage/' . $news->image) }}" class="img-fluid" alt="封面圖片">
                </div>
        ...
        $(document).ready(function () {
            $('.summernote').summernote({
                ...
                toolbar: [
                    ...
                    ['insert', ['link', 'picture', 'video', 'template']], // 自訂 template 按鈕
                ...
                buttons: {
                    template: function (context) {
                        ...
                        return ui.button({
                            contents: '<i class="note-icon-magic"></i> 範本',
                            tooltip: '插入範本',
                            click: function () {
            ...
            function sendFile(file, editor) {
                ...
                $.ajax({
                    ...
                    success: function (url) {
                        editor.summernote('insertImage', url); // 插入圖片
                    },
                    error: function (err) {
                        alert("上傳圖片失敗");
                    }

                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="general">
                            ...
                            <div class="row">
                                <div class="col-md-6"><label>密碼</label><input type="text" name="password"
                                        class="form-control"></div>
                                <div class="col-md-6"><label>確認密碼</label><input type="text" name="password_confirmation"
                                        class="form-control"></div>
                            </div>
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input perm-checkbox"
                                                        ...
                                                        id="perm_{{ $permKey }}" {{ $userHas ? 'checked' : '' }}>
                                                    <label class="custom-control-label" for="perm_{{ $permKey }}">
                                                        {{ $actLabel }}
                                                        <span class="role-owned-badge text-muted"
                                                            style="display:none; font-size:0.8em;">(角色已有)</span>
                                                    </label>
                                                </div>
                                            </div>
                                        @endforeach
                        ...
                        <div class="tab-pane fade" id="personal">
                            ...
                            <div class="col-md-6 form-group">
                                <label for="image">大頭貼</label>
                                <div class="input-group">
                                    <input type="file" id="avatar_url" name="avatar_url" class="form-control"
                                        aria-label="Upload image">
                                    @if ($isEdit && $user->avatar_url)
                                ...
                                @if (isset($imageSizes['avatar_url']))
                                    <small class="form-text text-muted">
                                        建議尺寸：{{ $imageSizes['avatar_url'][0] }} x {{ $imageSizes['avatar_url'][1] }}
                                    </small>
                                @endif
                            </div>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="imageModalLabel">大頭貼預覽</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <img src="{{ $UPLOAD_PATH . '/' . $user->avatar_url }}" class="img-fluid" alt="大頭貼">
                    </div>

...
<section class="page-banner">
    <div class="banner-img-wrap">
        <img src="https://images.unsplash.com/photo-1486427944299-d1955d23e34d?q=80&w=1920&auto=format&fit=crop"
...
<section class="section-news-list">
    <div class="container">
        ...
        @php
            $news_list = [
                [
                    'id' => 1, 'cat' => '新品上市', 'date' => '2025.03.15',
                    'title' => '春季限定：櫻花鹽漬奶油餅乾，浪漫登場',
                    'desc' => '嚴選日本進口八重櫻，搭配法國伊思尼發酵奶油，鹹甜交織的口感。',
                    'img' => 'https://images.unsplash.com/photo-1621236378699-8597fab6a0b6?q=80&w=800'
                ],
                [
                    'id' => 2, 'cat' => '活動快訊', 'date' => '2025.02.20',
                ...
                [
                    'id' => 3, 'cat' => '媒體報導', 'date' => '2025.01.10',
                    'title' => '榮獲 2024 年度最佳伴手禮推薦 Top 10',
                    'desc' => '感謝支持，這份榮耀屬於每一位喜愛 COOOOKIE 的你們。',
                    'img' => 'https://images.unsplash.com/photo-1605256485303-345383569777?q=80&w=800'
                ],
            ];
        @endphp

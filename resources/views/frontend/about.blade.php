...
@section('meta')
    ...
    <meta property="og:image"
        content="https://images.unsplash.com/photo-1558961363-fa8fdf82db35?q=80&w=1200&auto=format&fit=crop">
...
@push('styles')
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Noto+Serif+TC:wght@300;500;700;900&family=Inter:wght@300;500;700&display=swap"
        rel="stylesheet">
@endpush
...
@section('content')
    <main class="smooth-wrapper">
                ...
                <div class="hero__visual">
                    <div class="hero__img-mask js-clip-reveal">
                        ...
                        <img src="https://images.unsplash.com/photo-1558961363-fa8fdf82db35?q=80&w=1400&auto=format&fit=crop"
                            alt="COOOOKIE 手作工藝展示" class="hero__img js-parallax-img" loading="eager" width="800"
                            height="1000">
                    </div>
                    {{-- 裝飾元素 --}}
                        ...
                        <div class="story__visual js-fade-right">
                            <div class="img-frame">
                                <img src="https://images.unsplash.com/photo-1509440159596-0249088772ff?q=80&w=1000&auto=format&fit=crop"
                                    alt="烘焙職人專注的神情" class="js-parallax-slow" loading="lazy" width="800" height="1000">
                            </div>
                        </div>
        ...
        {{-- 4. 視差全幅背景：沈浸式體驗 --}}
        <section class="parallax-banner js-parallax-bg"
            style="background-image: url('https://images.unsplash.com/photo-1587678777691-3d0df519c046?q=80&w=1920&auto=format&fit=crop');">
                ...
                <div class="ing-grid">
                    <div class="ing-card js-fade-up" data-delay="0.1">
                        <div class="ing-img-box">
                            <img src="https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?q=80&w=600&auto=format&fit=crop"
                                alt="Butter">
                        </div>
                    ...
                    <div class="ing-card js-fade-up" data-delay="0.2">
                        <div class="ing-img-box">
                            <img src="https://images.unsplash.com/photo-1652283319196-9288add2d60c?q=80&w=600&auto=format&fit=crop"
                                alt="Flour">
                        </div>
                    ...
                    <div class="ing-card js-fade-up" data-delay="0.3">
                        <div class="ing-img-box">
                            <img src="https://images.unsplash.com/photo-1548169874-53e85f753f1e?q=80&w=600&auto=format&fit=crop"
                                alt="Eggs">
                        </div>
